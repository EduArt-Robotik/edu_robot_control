...
def generate_launch_description():
    ...
    rviz_config = os.path.join(package_path, 'parameter', 'arthur.rviz')

    rviz_node = Node(
      package='rviz2',
      executable='rviz2',
      name='rviz2',
      namespace=EnvironmentVariable('EDU_ROBOT_NAMESPACE', default_value="arthur"),
      arguments=['-d', rviz_config]
    )

    # Robot Description for Eduard
    launch_file_path = os.path.join(package_path, 'launch', 'arthur_robot_description.launch.py')
